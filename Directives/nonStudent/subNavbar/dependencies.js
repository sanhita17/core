(function(appServer,coreServer){
   ...
   document.write("<link rel=\'stylesheet\' type=\'text/css\' href=\'"+appServer+"client/vsl/velocity/ui/nonStudent/subNavbar/subNavbar.css\'>");
   ...
   // K5I_ELA_CLIENT | UI
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/classSelector/classSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/studentSelector/studentSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/strandSelector/strandSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/reportTypeSelector/reportTypeSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/nonStudent/subNavbar/subNavbar.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/nonStudent/subNavbar/app.js\'></script>");
