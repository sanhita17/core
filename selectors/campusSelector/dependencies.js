(function(appServer,coreServer){
   ...
   // K5I_ELA_CLIENT | UI
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/campusSelector/campusSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/campusSelector/app.js\'></script>");
