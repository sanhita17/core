(function($localPath){
   ...
   AppController.$inject=["$scope", "$timeout", "temporaryStorage"];

   function AppController($scope, $timeout, temporaryStorage) {

      $scope.$on("vsl.core.ui.testLogin:success",function(){
         console.log("EVENT --> vsl.core.ui.testLogin:success","studentSelector");
