(function(appServer,coreServer){
   ...
   document.write("<script src=\'"+appServer+"client/vsl/velocity/app/services/schoolClassList.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/app/services/classStudentList.js\'></script>");
   // K5I_ELA_CLIENT | UI
   ...
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/studentSelector/app.js\'></script>");
