(function(appServer,coreServer){
   ...
   // K5I_ELA_CLIENT | UI
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/districtSelector/districtSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/districtSelector/app.js\'></script>");
