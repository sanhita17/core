(function(appServer,coreServer){
   ...
   document.write("<link rel=\'stylesheet\' type=\'text/css\' href=\'"+appServer+"client/vsl/velocity/resources/styles/datepicker.css\'>");
   document.write("<link rel=\'stylesheet\' type=\'text/css\' href=\'"+appServer+"client/vsl/velocity/ui/pageHeader/pageHeader.css\'>");
   document.write("<link rel=\'stylesheet\' type=\'text/css\' href=\'"+appServer+"client/vsl/velocity/ui/selectors/timePeriodSelector/timePeriodSelector.css\'>");
   // CORE
   document.write("<script src=\'"+coreServer+"client/bower_components/jquery/dist/jquery.js\'></script>");
   document.write("<script src=\'"+coreServer+"client/bower_components/jquery-ui/jquery-ui.min.js\'></script>");
   ...
   document.write("<script src=\'"+appServer+"client/vsl/velocity/app/directives.js\'></script>");
   ...
   // K5I_ELA_CLIENT | UI
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/timePeriodSelector/timePeriodSelector.js\'></script>");
   document.write("<script src=\'"+appServer+"client/vsl/velocity/ui/selectors/timePeriodSelector/app.js\'></script>");
